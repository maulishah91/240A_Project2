...
CREATE TABLE TABLE_VER("PID" INTEGER,"COLUMNNO" INTEGER, "ATT" VARCHAR(10),"DECISION" VARCHAR(10),"WEIGHTS" INTEGER)@ 

--verticalization of code
INSERT INTO TABLE_VER (PID,COLUMNNO,ATT,DECISION,WEIGHTS) 
...
BEGIN ATOMIC
	...
	IF rand() > 0.8 THEN
		...
		SELECT * FROM TABLE_VER WHERE PID=temp.PID;
